...
from shop.models import Cart, Product, Transaction
from shop.utils.coupons_util import apply_coupon_discount
from shop.utils.selection import get_selected_account, get_selected_address
